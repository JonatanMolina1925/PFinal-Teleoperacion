...
function verificarContra(){
    ...
    if(pass.value && conpass.value){
        if (caracContra.test(pass.value))
        {
            if (pass.value != conpass.value) {
            ...
            pass.focus();
            $("#ComprobarContra").html("* Las contraseñas debe contener de 8 a 16 caracteres, una minúscula, una mayúscula y un número.");
            $("#ComprobarContra").css("color", "red"); 
            return 0;
        }  
    } else{
